...
<head>
    ...
    <title>{{ config('app.name', 'DodoTracking') }} - Enter your Mobile Number</title>
                    ...
                    <div class="bg-white rounded-md w-full overflow-hidden shadow">
                        <div class="p-6 md:px-10 rounded-lg bg-white">
                            <div class="md:flex md:justify-between md:items-center">
                                <div>
                                    <h2 style="margin-left: 10px;" class="text-xl text-gray-800 font-bold leading-tight">Forget Password ?</h2>
                                </div>
                            </div>
